...
\begin{wrapfigure}[19]{r}{0.3\textwidth}
 ...
 \small
 \import{figures/}{HiC-lab_p1.pdf_tex}}
...
\begin{wrapfigure}[17]{R}{0.3\textwidth}
 %\raisebox{0pt}[\dimexpr\height-2.0\baselineskip\relax]{
 \resizebox{0.3\textwidth}{!}{
 \small
 \import{figures/}{HiC-lab_p2.pdf_tex}}%}
...
\begin{wrapfigure}[22]{l}{0.3\textwidth}
 \resizebox{0.3\textwidth}{!}{
 \small
 \import{figures/}{chipseq_wetlab2.pdf_tex}}
...
\begin{wrapfigure}[14]{r}{0.3\textwidth}
 \resizebox{0.3\textwidth}{!}{
 \small
 \import{figures/}{chipseq_wetlab3.pdf_tex}}
